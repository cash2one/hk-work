...
$(function() {
    ...
    function calWidth() {
        ...
        $scroller.find("li").css({
            width: oneWidth + "px"
        });
        $scroller.css({
            width: oneWidth * scroller_size + 'px'
        });
        var myscroll = null;

        function loaded() {
            myscroll = new IScroll("#export_slides", {
                scrollX: true,
                scrollY: false,
                preventDefault: true,
    ...
    var popMenu = {
        openMenu: function() {
            ...
            $("#popMenu").css({
                width: '100%',
                height: popMenuHeight + 'px',
                position: 'absolute',
                left: 0,
                top: headerHeight + 'px',
                zIndex: 1000,
                overflow: 'hidden',
                backgroundColor: 'rgba(49,58,70,0.98)'
            });
            ...
            menuBtns.each(function(i) {
                ...
                $(this).on('click', function() {
                    ...
                    if (openBtn) {
                        ...
                        _this.parent().find("ul").stop().animate({
                            height: liSize * oneHeight + 'px'
                        }, 400, function() {
                            popMenu.refresh();
                            openBtn = false;
